...
const StyledWrapper = styled.div`
  ...
  .button:disabled .sparkle .path {
    color: #999;
  }

  .button:disabled .text_button {
    background-image: linear-gradient(90deg, #999 0%, #999 120%);
  }

  .button:disabled .dots_border::before {
    animation: none;
  }
  ...
  .button .dots_border::before {
    ...
    mask: linear-gradient(transparent 0%, #1a1a1a 120%);

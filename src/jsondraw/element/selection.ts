import { arrayToMap, isShallowEqual } from "@jsondraw/common";
...
export const getElementsWithinSelection = (
  ...
  selection: NonDeletedJsonDrawElement,
...
export const isSomeElementSelected = (function () {
  let lastElements: readonly NonDeletedJsonDrawElement[] | null = null;
...
export const getSelectedElements = (
  ...
  const addedElements = new Set<JsonDrawElement["id"]>();
  const selectedElements: JsonDrawElement[] = [];
  ...
  if (opts?.includeElementsInFrames) {
    const elementsToInclude: JsonDrawElement[] = [];
    selectedElements.forEach((element) => {
      if (isFrameLikeElement(element)) {
...
const _getLinearElementEditor = (
  ...
  allElements: readonly NonDeletedJsonDrawElement[],
) => {
    ...
    ...selectGroupsForSelectedElements(
      {
        ...
        selectedElementIds: excludeElementsInFramesFromSelection(
          targetElements,
        ).reduce((acc: Record<JsonDrawElement["id"], true>, element) => {

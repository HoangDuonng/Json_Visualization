...
export type ElementUpdate<TElement extends JsonDrawElement> = Omit<
  Partial<TElement>,
  "id" | "updated"
>;
 ...
 * use `scene.mutateElement` or `JsonDrawImperativeAPI.mutateElement` instead.
 */
export const mutateElement = <TElement extends Mutable<JsonDrawElement>>(
  element: TElement,
  ...
  if (
    ...
    updates = {
      ...
      ...updateElbowArrowPoints(
        ...
        updates as ElementUpdate<JsonDrawElbowArrowElement>,
        options,
      ),
    };
...
export const newElementWith = <TElement extends JsonDrawElement>(
  element: TElement,
  updates: ElementUpdate<TElement>,
 ...
 */
export const bumpVersion = <T extends Mutable<JsonDrawElement>>(
  element: T,

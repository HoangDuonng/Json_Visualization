import { pointDistance, pointFrom, type GlobalPoint } from "@jsondraw/math";
import { invariant } from "@jsondraw/common";

import type { AppState, NullableGridSize } from "@jsondraw/jsondraw/types";
...
const focusPointUpdate = (
  arrow: JsonDrawArrowElement,
  bindableElement: JsonDrawBindableElement | null,
...
export const handleFocusPointPointerUp = (
  ...
  const arrow = LinearElementEditor.getElement<JsonDrawArrowElement>(
    linearElementEditor.elementId,

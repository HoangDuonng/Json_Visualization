import { invariant, isTransparent, type Bounds } from "@jsondraw/common";
import {
...
import type { FrameNameBounds } from "@jsondraw/jsondraw/types";
...
export const shouldTestInside = (element: JsonDrawElement) => {
...
let cachedElement: WeakRef<JsonDrawElement> | null = null;
...
export const getAllHoveredElementAtPoint = (
  ...
  elementsMap: NonDeletedSceneElementsMap,
  tolerance?: number,
): NonDeleted<JsonDrawBindableElement>[] => {
  const candidateElements: NonDeleted<JsonDrawBindableElement>[] = [];
...
export const getHoveredElementForBinding = (
  ...
  elementsMap: NonDeletedSceneElementsMap,
  tolerance?: number,
): NonDeleted<JsonDrawBindableElement> | null => {
  ...
  return candidateElements
    ...
    .pop() as NonDeleted<JsonDrawBindableElement>;
};
...
export const getHoveredElementForFocusPoint = (
  ...
  return distanceFilteredCandidateElements[0] as NonDeleted<JsonDrawBindableElement>;
};
...
const intersectLinearOrFreeDrawWithLineSegment = (
  element: JsonDrawLinearElement | JsonDrawFreeDrawElement,
  segment: LineSegment<GlobalPoint>,
  onlyFirst = false,
): GlobalPoint[] => {
...
const intersectRectanguloidWithLineSegment = (
  element: JsonDrawRectanguloidElement,
  elementsMap: ElementsMap,
  segment: LineSegment<GlobalPoint>,
  offset: number = 0,
  onlyFirst = false,
...
const intersectDiamondWithLineSegment = (
  element: JsonDrawDiamondElement,
  elementsMap: ElementsMap,
...
const intersectEllipseWithLineSegment = (
  element: JsonDrawEllipseElement,
  elementsMap: ElementsMap,
  l: LineSegment<GlobalPoint>,
  offset: number = 0,
): GlobalPoint[] => {
...
export const isBindableElementInsideOtherBindable = (
  innerElement: JsonDrawBindableElement,
  outerElement: JsonDrawBindableElement,
  elementsMap: ElementsMap,
): boolean => {

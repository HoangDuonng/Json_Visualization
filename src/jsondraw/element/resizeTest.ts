...
import type { GlobalPoint, LineSegment, LocalPoint } from "@jsondraw/math";

import type { AppState, Zoom } from "@jsondraw/jsondraw/types";
...
export const getElementWithTransformHandleType = (
  ...
  }, null as { element: NonDeletedJsonDrawElement; transformHandleType: MaybeTransformHandleType } | null);
};

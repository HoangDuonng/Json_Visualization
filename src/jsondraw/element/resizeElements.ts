...
import type { PointerDownState } from "@jsondraw/jsondraw/types";
...
const rotateSingleElement = (
  ...
  let update: ElementUpdate<NonDeletedJsonDrawElement> = {
    angle,
  };
  ...
  if (isBindingElement(element)) {
    update = {
      ...update,
    } as ElementUpdate<JsonDrawArrowElement>;
  ...
  if (boundTextElementId) {
    const textElement =
      scene.getElement<JsonDrawTextElementWithContainer>(boundTextElementId);
...
export const measureFontSizeFromWidth = (
  element: NonDeleted<JsonDrawTextElement>,
...
export const resizeSingleTextElement = (
  origElement: NonDeleted<JsonDrawTextElement>,
  element: NonDeleted<JsonDrawTextElement>,
  scene: Scene,
  ...
  if (transformHandleType === "e" || transformHandleType === "w") {
    ...
    const resizedElement: Partial<JsonDrawTextElement> = {
...
export const resizeSingleElement = (
  ...
  if (
    ...
    let updates: ElementUpdate<JsonDrawElement> = {
      ...newOrigin,
...
export const resizeMultipleElements = (
  ...
  const targetElements = selectedElements.reduce(
    (
      acc: {
        ...
        orig: NonDeletedJsonDrawElement;
        /** latest element */
  ...
  if (nextWidth && nextHeight) {
    ...
    const elementsAndUpdates: {
      element: NonDeletedJsonDrawElement;
      update: Mutable<
        Pick<JsonDrawElement, "x" | "y" | "width" | "height" | "angle">
      > & {
        points?: JsonDrawLinearElement["points"];
        fontSize?: JsonDrawTextElement["fontSize"];
        scale?: JsonDrawImageElement["scale"];
        boundTextFontSize?: JsonDrawTextElement["fontSize"];
        startBinding?: JsonDrawElbowArrowElement["startBinding"];
        endBinding?: JsonDrawElbowArrowElement["endBinding"];
        fixedSegments?: JsonDrawElbowArrowElement["fixedSegments"];
      };
    }[] = [];
    ...
    for (const { orig, latest } of targetElements) {
      ...
      ) as JsonDrawTextElementWithContainer | undefined;

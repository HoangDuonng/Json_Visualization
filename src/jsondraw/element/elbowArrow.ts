...
import {
  type JsonDrawElbowArrowElement,
...
type ElbowArrowData = {
  ...
  endHeading: Heading;
  commonBounds: Bounds;
  hoveredStartElement: JsonDrawBindableElement | null;
  hoveredEndElement: JsonDrawBindableElement | null;
};
...
const handleSegmentMove = (
  ...
  hoveredStartElement: JsonDrawBindableElement | null,
  hoveredEndElement: JsonDrawBindableElement | null,
): ElementUpdate<JsonDrawElbowArrowElement> => {
...
export const updateElbowArrowPoints = (
  arrow: Readonly<JsonDrawElbowArrowElement>,
  elementsMap: NonDeletedSceneElementsMap,
  updates: {
...
const normalizeArrowElementUpdate = (
  ...
  startIsSpecial?: JsonDrawElbowArrowElement["startIsSpecial"],
  endIsSpecial?: JsonDrawElbowArrowElement["startIsSpecial"],
): ElementUpdate<JsonDrawElbowArrowElement> => {
...
const getGlobalPoint = (
  ...
  element?: JsonDrawBindableElement | null,
  elementsMap?: ElementsMap,
  isDragging?: boolean,
): GlobalPoint => {
  if (isDragging) {
...
const getBindPointHeading = (
  ...
  hoveredElement: JsonDrawBindableElement | null | undefined,

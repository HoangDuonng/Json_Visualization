...
import type { FontString, JsonDrawTextElement } from "./types";
 ...
 */
export const detectLineHeight = (textElement: JsonDrawTextElement) => {
  const lineCount = splitIntoLines(textElement.text).length;
  return (textElement.height /
    lineCount /
    textElement.fontSize) as JsonDrawTextElement["lineHeight"];
};

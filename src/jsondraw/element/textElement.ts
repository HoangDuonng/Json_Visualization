...
import { pointFrom, pointRotateRads, type Radians } from "@jsondraw/math";

import type { AppState } from "@jsondraw/jsondraw/types";

import type { ExtractSetType } from "@jsondraw/common/utility-types";
...
export const redrawTextBoundingBox = (
  ...
  container: JsonDrawElement | null,
  scene: Scene,
) => {
  ...
  if (container) {
    const maxContainerHeight = getBoundTextMaxHeight(
      container,
      textElement as JsonDrawTextElementWithContainer,
    );
    ...
    const updatedTextElement = {
      ...textElement,
      ...boundTextUpdates,
    } as JsonDrawTextElementWithContainer;
...
export const handleBindTextResize = (
  container: NonDeletedJsonDrawElement,
  scene: Scene,
...
export const computeBoundTextPosition = (
  ...
  boundTextElement: JsonDrawTextElementWithContainer,
...
export const getBoundTextElementId = (container: JsonDrawElement | null) => {
...
export const getBoundTextElement = (
  ...
  if (boundTextElementId) {
    return (elementsMap.get(boundTextElementId) ||
      null) as JsonDrawTextElementWithContainer | null;
  }
  return null;
};

export const getContainerElement = (
  element: JsonDrawTextElement | null,
  elementsMap: ElementsMap,
): JsonDrawTextContainer | null => {
  if (!element) {
    return null;
  }
  if (element.containerId) {
    return (elementsMap.get(element.containerId) ||
      null) as JsonDrawTextContainer | null;
  }
  return null;
};
...
export const getContainerCoords = (container: NonDeletedJsonDrawElement) => {
  let offsetX = BOUND_TEXT_PADDING;
  let offsetY = BOUND_TEXT_PADDING;

  if (container.type === "ellipse") {
    // The derivation of coordinates is explained in https://github.com/jsondraw/jsondraw/pull/6172
    offsetX += (container.width / 2) * (1 - Math.sqrt(2) / 2);
    offsetY += (container.height / 2) * (1 - Math.sqrt(2) / 2);
  }
  // The derivation of coordinates is explained in https://github.com/jsondraw/jsondraw/pull/6265
...
export const getBoundTextMaxWidth = (
  container: JsonDrawElement,
  boundTextElement: JsonDrawTextElement | null,
) => {
  ...
  if (container.type === "ellipse") {
    ...
    // equation of an ellipse -https://github.com/jsondraw/jsondraw/pull/6172
    return Math.round((width / 2) * Math.sqrt(2)) - BOUND_TEXT_PADDING * 2;
  }
  if (container.type === "diamond") {
    // The width of the largest rectangle inscribed inside a rhombus is
    // Math.round(width / 2) - https://github.com/jsondraw/jsondraw/pull/6265
...
export const getBoundTextMaxHeight = (
  ...
  if (container.type === "diamond") {
    ...
    // Math.round(height / 2) - https://github.com/jsondraw/jsondraw/pull/6265

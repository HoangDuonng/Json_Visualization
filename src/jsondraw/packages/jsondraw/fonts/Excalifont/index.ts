...
copyright: Copyright (c) 2024 by JsonDraw. All rights reserved.
...
trademark: Excalifont is a trademark of JsonDraw.
...
export const ExcalifontFontFaces: JsonDrawFontFaceDescriptor[] = [
  {
    uri: _0,
    descriptors: {
      unicodeRange:

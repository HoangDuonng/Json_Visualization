...
import { normalizeLink, toValidURL } from "@jsondraw/common";
import { hashString } from "@jsondraw/element";
...
import { getBoundTextElement, getContainerElement } from "@jsondraw/element";
import { getLineHeightInPx } from "@jsondraw/element";
import {
  isArrowElement,
  isIframeLikeElement,
...
import { getCornerRadius, isPathALoop } from "@jsondraw/element";
...
const renderElementToSvg = (
  ...
  const addToRoot = (node: SVGElement, element: JsonDrawElement) => {
    if (isTestEnv()) {

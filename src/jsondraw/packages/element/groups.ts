...
export const selectGroupsForSelectedElements = (function () {
  ...
  let lastSelectedElements: readonly NonDeleted<JsonDrawElement>[] | null =
    null;
  let lastElements: readonly NonDeleted<JsonDrawElement>[] | null = null;
  let lastReturnValue: SelectGroupsReturnType | null = null;

  const _selectGroups = (
    selectedElements: readonly NonDeleted<JsonDrawElement>[],
    elements: readonly NonDeleted<JsonDrawElement>[],
...
export const editGroupForSelectedElement = (
  appState: AppState,
  element: NonDeleted<JsonDrawElement>,
): AppState => {
  return {
    ...appState,
...
export const isElementInGroup = (element: JsonDrawElement, groupId: string) =>
...
export const getElementsInGroup = (
  ...
  const elementsInGroup: JsonDrawElement[] = [];
...
export const addToGroup = (
  prevGroupIds: JsonDrawElement["groupIds"],
  newGroupId: GroupId,
  editingGroupId: AppState["editingGroupId"],
) => {
...
export const removeFromSelectedGroups = (
  groupIds: JsonDrawElement["groupIds"],
  selectedGroupIds: { [groupId: string]: boolean },
...
export const getMaximumGroups = (
  ...
  const groups: Map<String, JsonDrawElement[]> = new Map<
    String,
    JsonDrawElement[]
  >();
  elements.forEach((element: JsonDrawElement) => {
    const groupId =
...
export const isInGroup = (element: NonDeletedJsonDrawElement) => {
...
export const getSelectedElementsByGroup = (
  ...
  const groups: Map<string, JsonDrawElement[]> = new Map();
  const elements: Map<string, JsonDrawElement[]> = new Map();

  // helper function to add an element to the elements map
  const addToElementsMap = (element: JsonDrawElement) => {
    // elements
  ...
  const addToGroupsMap = (element: JsonDrawElement, groupId: string) => {
    // groups
    const currentGroupMembers = groups.get(groupId) || [];
    const boundTextElement = getBoundTextElement(element, elementsMap);

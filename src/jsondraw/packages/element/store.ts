...
import type App from "@jsondraw/jsondraw/components/App";

import type { DTO, ValueOf } from "@jsondraw/common/utility-types";

import type { AppState, ObservedAppState } from "@jsondraw/jsondraw/types";
...
export class StoreChange {
  ...
  private constructor(
    public readonly elements: Record<string, OrderedJsonDrawElement>,
...
export class StoreSnapshot {
  ...
  public getChangedElements(prevSnapshot: StoreSnapshot) {
    const changedElements: Record<string, OrderedJsonDrawElement> = {};

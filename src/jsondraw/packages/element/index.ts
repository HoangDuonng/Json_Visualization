import { toIterable } from "@jsondraw/common";
 ...
 */
export const getSceneVersion = (elements: readonly JsonDrawElement[]) =>
...
export const getVisibleElements = (elements: readonly JsonDrawElement[]) =>
  elements.filter(
    (el) => !el.isDeleted && !isInvisiblySmallElement(el),
  ) as readonly NonDeletedJsonDrawElement[];

export const getNonDeletedElements = <T extends JsonDrawElement>(
  elements: readonly T[],
) =>
  elements.filter((element) => !element.isDeleted) as readonly NonDeleted<T>[];

export const isNonDeletedElement = <T extends JsonDrawElement>(
  element: T,

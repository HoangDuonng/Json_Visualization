...
import { getCurvePathOps } from "@jsondraw/utils/shape";
...
export class LinearElementEditor {
  public readonly elementId: JsonDrawElement["id"] & {
    _brand: "jsondrawLinearElementId";
  };
  /** indices */
   ...
   *  statically guarantee this method returns an JsonDrawLinearElement)
   */
  static getElement<T extends JsonDrawLinearElement>(
  ...
  static handlePointerMove(
    ...
    const startBindingElement =
      ...
      ) as JsonDrawBindableElement | null);
  ...
  static handlePointerDown(
    ...
    didAddPoint: boolean;
    hitElement: NonDeleted<JsonDrawElement> | null;
   ...
   * of the points.
   */
  static getNormalizeElementPointsAndCoords(element: JsonDrawLinearElement) {
  ...
  static deleteFixedSegment(
    element: JsonDrawElbowArrowElement,
    scene: Scene,
    index: number,
  ): void {
    scene.mutateElement(element, {

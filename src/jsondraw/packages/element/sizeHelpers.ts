...
import type { AppState, Offsets, Zoom } from "@jsondraw/jsondraw/types";
...
import type { ElementsMap, JsonDrawElement } from "./types";
...
export const getNormalizedDimensions = (
  element: Pick<JsonDrawElement, "width" | "height" | "x" | "y">,
): {
  width: JsonDrawElement["width"];
  height: JsonDrawElement["height"];
  x: JsonDrawElement["x"];
  y: JsonDrawElement["y"];
} => {
  const ret = {

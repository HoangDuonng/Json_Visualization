...
export class ShapeCache {
   ...
   */
  public static get = <T extends JsonDrawElement>(
    element: T,
  ...
  public static delete = (element: JsonDrawElement) => {
  ...
  public static generateElementShape = <
    T extends Exclude<JsonDrawElement, JsonDrawSelectionElement>,
  >(
    element: T,
    renderConfig: {
      isExporting: boolean;
...
function adjustRoughness(element: JsonDrawElement): number {
...
const _generateElementShape = (
  element: Exclude<NonDeletedJsonDrawElement, JsonDrawSelectionElement>,
  generator: RoughGenerator,
  {
    isExporting,
    canvasBackgroundColor,
...
/**
 * get the pure geometric shape of an jsondraw elementw
...
export const toggleLinePolygonState = (
  ...
  // TODO: satisfies ElementUpdate<JsonDrawLineElement>
  const ret = {
...
const getFreeDrawSvgPath = (element: JsonDrawFreeDrawElement) => {
...
export const getFreedrawOutlinePoints = (
  element: JsonDrawFreeDrawElement,
) => {

...
const getCanvasPadding = (element: JsonDrawElement) => {
  switch (element.type) {
    case "freedraw":
...
export const getRenderOpacity = (
  element: JsonDrawElement,
  containingFrame: JsonDrawFrameLikeElement | null,
  elementsPendingErasure: ElementsPendingErasure,
  pendingNodes: Readonly<PendingJsonDrawElements> | null,
...
export interface JsonDrawElementWithCanvas {
  element: JsonDrawElement | JsonDrawTextElement;
  ...
  imageCrop: JsonDrawImageElement["crop"] | null;
...
): JsonDrawElementWithCanvas | null => {
...
const drawElementFromCanvas = (
  elementWithCanvas: JsonDrawElementWithCanvas,
  context: CanvasRenderingContext2D,
  renderConfig: StaticCanvasRenderConfig,
  appState: StaticCanvasAppState | InteractiveCanvasAppState,

import type { UserIdleState, EditorInterface } from "@jsondraw/common";
import type {
  JsonDrawElement,
...
export type StaticCanvasRenderConfig = {
  ...
  pendingFlowchartNodes: PendingJsonDrawElements | null;
...
export type InteractiveCanvasRenderConfig = {
  ...
  // ---------------------------------------------------------------------------
  remoteSelectedElementIds: Map<JsonDrawElement["id"], SocketId[]>;
...
export type NewElementSceneRenderConfig = {
  canvas: HTMLCanvasElement | null;
  rc: RoughCanvas;
  newElement: JsonDrawElement | null;
  elementsMap: RenderableElementsMap;
  allElementsMap: NonDeletedSceneElementsMap;
  scale: number;
  appState: AppState;

...
import { getElementsOverlappingFrame } from "@jsondraw/element";
...
export type ExportedElements = readonly NonDeletedJsonDrawElement[] & {
...
export const prepareElementsForExport = (
  ...
  let exportingFrame: JsonDrawFrameLikeElement | null = null;
...
export const exportCanvas = async (
    ...
    if (type === "svg") {
      return fileSave(
        ...
        }),
        {
          ...
          name,
          extension: appState.exportEmbedScene ? "jsondraw.svg" : "svg",
  ...
  if (type === "png") {
    ...
    return fileSave(blob, {
      ...
      name,
      extension: appState.exportEmbedScene ? "jsondraw.png" : "png",

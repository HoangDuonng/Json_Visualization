import { GOOGLE_FONTS_RANGES } from "@jsondraw/common";

import { type JsonDrawFontFaceDescriptor } from "../Fonts";
...
export const NunitoFontFaces: JsonDrawFontFaceDescriptor[] = [
  {
    uri: CyrilicExt,
    descriptors: {

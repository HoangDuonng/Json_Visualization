import { arrayToMap, type Bounds } from "@jsondraw/common";
import { getElementBounds } from "@jsondraw/element";
import {
  isArrowElement,
  isJsonDrawElement,
  isFreeDrawElement,
...
type Element = NonDeletedJsonDrawElement;
type Elements = readonly NonDeletedJsonDrawElement[];
...
const getNonLinearElementRelativePoints = (
  element: Exclude<
    Element,
    JsonDrawLinearElement | JsonDrawFreeDrawElement
  >,
): [
  TopLeft: LocalPoint,
  TopRight: LocalPoint,
...
/** @returns vertices relative to element's top-left [0,0] position  */
const getElementRelativePoints = (element: JsonDrawElement): Points => {
